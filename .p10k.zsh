# Generated by Powerlevel10k configuration wizard on 2020-06-22 at 11:18 -03.
...
() {
  ...
  # is empty.
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${${CONDA_DEFAULT_ENV#\(}% }%\)}:-${CONDA_PREFIX:t}}'
