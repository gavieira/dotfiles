#Config adapted from https://github.com/trev-dev/dotfiles 
...
def run_once():
    autostart.init_apps_once()

# Setting monitors names
monitor1 = 'LVDS1'
monitor2 = 'VGA1'
monitor3 = 'HDMI1'

# Run commands when qtile restarts
@hook.subscribe.startup
def run_always():
    autostart.init_monitors(monitor1, monitor2, monitor3)
